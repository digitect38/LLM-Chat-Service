...
script = r'''# Restart RagService only, then delete + re-ingest
...
with codecs.open(r"D:\__WORK2__\LLM-Chat-Service-master\scripts\restart-rag.ps1", "w", "utf-8-sig") as f:
    f.write(script)

print("Written restart-rag.ps1")
